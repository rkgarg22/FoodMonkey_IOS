...
class DBManager: NSObject {
    ...
    class func cleanUpUserDefaults()
    {
        ...
        defaults.removeObject(forKey: Defaults.isLoggedIn.rawValue)
        defaults.removeObject(forKey: Defaults.login.rawValue)
        defaults.removeObject(forKey: Defaults.accessToken.rawValue)
        
      //  ChatDBManager.sharedInstance.deleteAllRecordsOfChat()
    }
    
    class func cleanlocationCordinated()
    {
        let defaults :UserDefaults = UserDefaults.standard
    }
